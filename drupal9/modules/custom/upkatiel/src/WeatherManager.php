...
class WeatherManager implements WeatherManagerInterface {
  ...
  public function getCollection(\DateTime $date, $location) {
    ...
    $WEATHER_API_URL = 'http://api.worldweatheronline.com/premium/v1/weather.ashx?q='.$location.'&date='.$date->format('Y-m-d').'&key=f0e91fdbe3ba44a6acd145522220910&format=json&includelocation=yes';
